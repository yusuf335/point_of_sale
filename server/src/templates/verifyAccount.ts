...
export const sendAccountVerificationEmail = async (
  ...
  try {
    ...
    const template = Handlebars.compile(verificationHTMLTemplate);

    // Generate the HTML content by injecting dynamic data
    const html = template({
      verificationLink: `http://localhost:3000/verify-account?token=${token}`,
    });
    // Send email
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        ...
                                        height="auto"
                                        src="https://www.mytradebee.com/wp-content/uploads/2024/12/8422313_3901287-scaled.jpg"
                                        style="
                                          display: block;
                                          height: auto;
                                          border: 0;
                                      ...
                                      >
                                        <span
                                          style="
                                            ...
                                            font-size: 14px;
                                          "
                                          >Click the button below to verify the email address. </br>
